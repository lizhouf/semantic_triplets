...
def pred_input(pred_filename):
    ...
    files.download("{}.conll".format(pred_filename))
...
# from google.colab import files
# download txt and csv file
# files.download("{}_cleaned.txt".format(filename)) 
# files.download("{}_cleaned.csv".format(filename))
